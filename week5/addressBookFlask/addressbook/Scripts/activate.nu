...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\texas\dev\bryanUniversity\AFS\afs-200\week5\addressBookFlask\addressbook'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\texas\dev\bryanUniversity\AFS\afs-200\week5\addressBookFlask\addressbook\Scripts\deactivate.nu'
